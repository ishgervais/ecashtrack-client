...
export default function AuthLayout(props: AuthLayoutType) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 md:h-screen gap-5 w-full ">
            <div className="hidden col-span-1 lg:col-span-2 bg-primary h-inherit md:flex items-center ">
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-1 h-screen flex px-10  w-full items-center justify-center">
